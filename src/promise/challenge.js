...
/* Fetching data from the API and then logging the response to the console. */
fetchData(`${API}/products`)
    ...
    .then(() => {
        console.log('Prueba de que se pueden añadir todos los then que queramos');
    })
    .catch(error => console.log(error))
    .finally(() => {
        console.log("Este es el fin amigos!");
    });
...
Prueba de que se pueden añadir todos los then que queramos
